...
console.table([ "1"+2, 1+"2", 1+2+"2", "1"+2+2, "1"+2+"2", "1"+"2"+3+4, 1+2+3 ]);
console.table([ typeof ("1"+2), typeof (1+"2"), typeof (1+2+"2"), typeof ("1"+2+2), typeof ("1"+2+"2"), typeof ("1"+"2"+3+4), typeof (1+2+3) ]);
console.log("================================================================================================================");
